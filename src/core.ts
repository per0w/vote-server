...
export const setEntries = (state: Map<string, List<string>>, entries: List<string> | string[]) => {
...
export const next = (state: Map<string, any>, round = state.getIn(['vote', 'round'], 0)) => {
...
export const restart = (state: Map<string, any>) => {
